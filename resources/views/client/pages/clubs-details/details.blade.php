        ...
        <div class="content">
            ...
            <div class="table-responsive border rounded">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>25 tháng 12 năm 2024</td>
                            <td>18:00 - 20:00</td>
                            <td>Workshop Truyền thông Sáng tạo</td>
                            <td>Trung tâm hội nghị Thành phố Hà Nội</td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>1 tháng 1 năm 2025</td>
                            <td>14:00 - 16:00</td>
                            <td>Chương trình Giao lưu Sinh viên</td>
                            <td>Công viên Thống Nhất, Hà Nội</td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>10 tháng 1 năm 2025</td>
                            <td>09:00 - 12:00</td>
                            <td>Seminar Marketing Online</td>
                            <td>Khách sạn Metropole, Hà Nội</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <style>
                .card-img {
                    ...
                    object-fit: cover; /* Giữ tỷ lệ và cắt phần thừa nếu cần */
                    width: 100%; /* Đảm bảo chiều rộng chiếm 100% của phần tử cha */
                }
            </style>
