...
<div style="background-color: #f8f9fa; padding: 0px 0;">
    ...
    <div class="container pb-5" style="max-width: 100%; padding: 50px; background-color: #f9eff1;">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4">
            ...
            <div class="col">
                <div class="card shadow-sm border-0 rounded-lg bg-light" style="transition: transform 0.3s;">
                    <img src="{{asset('assets/client/images/clb-lt.jpg')}}" alt="CLB" class="card-img-top rounded-top" style="height: 180px; object-fit: cover;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 1.25rem; font-weight: bold;"> CLB Lập trình C/C++</h5>
                        <p class="card-text" style="font-size: 14px;">Khám phá các hoạt động thú vị và sôi nổi của  CLB Lập trình C/C++.</p>
                    </div>
                    <div class="card-footer d-flex justify-content-between position-relative">
                        <a href="#" class="text-decoration-none text-muted like-icon">
                            <i class="ph-heart me-2" style="cursor: pointer;"></i>
            ...
            <div class="col">
                <div class="card shadow-sm border-0 rounded-lg bg-light" style="transition: transform 0.3s;">
                    <img src="{{asset('assets/client/images/dclv.jpg')}}" alt="CLB" class="card-img-top rounded-top" style="height: 180px; object-fit: cover;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 1.25rem; font-weight: bold;">  CLB Đồ cũ là vàng</h5>
                        <p class="card-text" style="font-size: 14px;">Khám phá các hoạt động thú vị và sôi nổi của CLB Đồ cũ là vàng</p>
                    </div>
                    <div class="card-footer d-flex justify-content-between position-relative">
                        <a href="#" class="text-decoration-none text-muted like-icon">
                            <i class="ph-heart me-2" style="cursor: pointer;"></i>
            ...
            <div class="col">
                <div class="card shadow-sm border-0 rounded-lg bg-light" style="transition: transform 0.3s;">
                    <img src="{{asset('assets/client/images/tvtv.jpg')}}" alt="CLB" class="card-img-top rounded-top" style="height: 180px; object-fit: cover;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 1.25rem; font-weight: bold;"> CLB Tư vấn - Tham vấn</h5>
                        <p class="card-text" style="font-size: 14px;">Khám phá các hoạt động thú vị và sôi nổi của CLB Tư vấn - Tham vấn.</p>
                    </div>
                    <div class="card-footer d-flex justify-content-between position-relative">
                        <a href="#" class="text-decoration-none text-muted like-icon">
                            <i class="ph-heart me-2" style="cursor: pointer;"></i>
            ...
            <div class="col">
                <div class="card shadow-sm border-0 rounded-lg bg-light" style="transition: transform 0.3s;">
                    <img src="{{asset('assets/client/images/vtvd.jpg')}}" alt="CLB" class="card-img-top rounded-top" style="height: 180px; object-fit: cover;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 1.25rem; font-weight: bold;">CLB Văn Trang Võ Đạo</h5>
                        <p class="card-text" style="font-size: 14px;">Khám phá các hoạt động thú vị và sôi nổi của CLB Văn Trang Võ Đạo.</p>
                    </div>
                    <div class="card-footer d-flex justify-content-between position-relative">
                        <a href="#" class="text-decoration-none text-muted like-icon">
                            <i class="ph-heart me-2" style="cursor: pointer;"></i>
            ...
            <div class="col">
                <div class="card shadow-sm border-0 rounded-lg bg-light" style="transition: transform 0.3s;">
                    <img src="{{asset('assets/client/images/kn.jpg')}}" alt="CLB" class="card-img-top rounded-top" style="height: 180px; object-fit: cover;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 1.25rem; font-weight: bold;"> CLB Khởi nghiệp</h5>
                        <p class="card-text" style="font-size: 14px;">Khám phá các hoạt động thú vị và sôi nổi của CLB Khởi nghiệp</p>
                    </div>
                    <div class="card-footer d-flex justify-content-between position-relative">
                        <a href="#" class="text-decoration-none text-muted like-icon">
                            <i class="ph-heart me-2" style="cursor: pointer;"></i>
            ...
            <div class="col">
                <div class="card shadow-sm border-0 rounded-lg bg-light" style="transition: transform 0.3s;">
                    <img src="{{asset('assets/client/images/tt.jpg')}}" alt="CLB" class="card-img-top rounded-top" style="height: 180px; object-fit: cover;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 1.25rem; font-weight: bold;"> CLB Truyền thông</h5>
                        <p class="card-text" style="font-size: 14px;">Khám phá các hoạt động thú vị và sôi nổi của  CLB Truyền thông.</p>
                    </div>
            ...
            <div class="col">
                <div class="card shadow-sm border-0 rounded-lg bg-light" style="transition: transform 0.3s;">
                    <img src="{{asset('assets/client/images/bd.jpg')}}" alt="CLB" class="card-img-top rounded-top" style="height: 180px; object-fit: cover;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 1.25rem; font-weight: bold;"> CLB Bóng đá VNUA</h5>
                        <p class="card-text" style="font-size: 14px;">Khám phá các hoạt động thú vị và sôi nổi của  CLB Bóng đá VNUA.</p>
                    </div>
                    <div class="card-footer d-flex justify-content-between position-relative">
                        <a href="#" class="text-decoration-none text-muted like-icon">
                            <i class="ph-heart me-2" style="cursor: pointer;"></i>
