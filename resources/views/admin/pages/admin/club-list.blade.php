    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <table class="table datatable-scroll-y" width="100%">
                ...
                <tr>
                    <td>{{ $club->name }}</td>
                    <td><a href="#">{{ $club->president->name ?? 'Chưa có chủ tịch' }}</a></td>
                    {{-- <td>{{ $club->description }}</td> --}}
                    <td>{{ number_format($club->balance, 0, ',', '.') }} VNĐ</td>
                    <td>
                        <span class="badge {{ $club->status == 'active' ? 'bg-success bg-opacity-10 text-success' : 'bg-danger bg-opacity-10 text-danger' }}">
